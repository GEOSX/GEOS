...
template< typename SUBREGION_TYPE,
          ...
          typename FE_TYPE >
ImplicitSmallStrainQuasiStaticPressurizedDamage< SUBREGION_TYPE, CONSTITUTIVE_TYPE, FE_TYPE >::
                                                                                                                           ...
                                                                                                                           STRESS_MODIFIER && stressModifier ) const
{
  ...
  // Add the pressure term in the phase-field crack
  ...
  LvArray::tensorOps::symAddIdentity< 3 >( stress, pressureDamageFunction*currentDamagePressure );
