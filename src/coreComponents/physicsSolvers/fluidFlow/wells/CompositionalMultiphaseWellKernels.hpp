...
struct PerforationKernel
{
  ...
  compute( bool const & disableReservoirToWellFlow,
           ...
           arraySlice2d< real64 const, constitutive::relperm::USD_RELPERM - 2 > const & resPhaseRelPerm,
           arraySlice3d< real64 const, constitutive::relperm::USD_RELPERM_DS - 2 > const & dResPhaseRelPerm_dPhaseVolFrac,
  ...
  launch( localIndex const size,
          ...
          ElementViewConst< arrayView4d< real64 const, constitutive::relperm::USD_RELPERM > > const & resPhaseRelPerm,
          ElementViewConst< arrayView5d< real64 const, constitutive::relperm::USD_RELPERM_DS > > const & dResPhaseRelPerm_dPhaseVolFrac,
          arrayView1d< real64 const > const & wellElemGravCoef,
