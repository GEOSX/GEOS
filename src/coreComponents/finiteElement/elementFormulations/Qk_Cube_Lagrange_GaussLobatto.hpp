...
class Qk_Cube_Lagrange_GaussLobatto final : public FiniteElementBase
{
public:
  ...
  ~Qk_Cube_Lagrange_GaussLobatto() = default;
...
GEOS_FORCE_INLINE
void
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::supportLoop( real64 const (&coords)[3],
                                                              FUNC && func,
                                                              PARAMS &&... params )
{
...
GEOS_FORCE_INLINE
void
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::supportLoop( localIndex const q,
                                                              FUNC && func,
                                                              PARAMS &&... params )
{
  int qa, qb, qc;
...
GEOS_FORCE_INLINE
real64
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::calcGradN( localIndex const q,
                                                            real64 const (&X)[numNodes][3],
                                                            real64 (& gradN)[numNodes][3] )
{
  int qa, qb, qc;
...
GEOS_FORCE_INLINE
real64
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::calcGradN( real64 const (&coords)[3],
                                                            real64 const (&X)[numNodes][3],
                                                            real64 (& gradN)[numNodes][3] )
{
  real64 J[3][3] = {{0}};
...
GEOS_HOST_DEVICE
GEOS_FORCE_INLINE
real64 Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::
...
GEOS_FORCE_INLINE
real64
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::calcGradNWithCorners( localIndex const q,
                                                                       real64 const (&X)[8][3],
                                                                       real64 (& gradN)[numNodes][3] )
{
  int qa, qb, qc;
...
GEOS_FORCE_INLINE
real64
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::calcGradNWithCorners( real64 const (&coords)[3],
                                                                       real64 const (&X)[8][3],
                                                                       real64 (& gradN)[numNodes][3] )
{
  real64 J[3][3] = {{0}};
...
GEOS_FORCE_INLINE
void
Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::
...
GEOS_HOST_DEVICE
GEOS_FORCE_INLINE
void Qk_Cube_Lagrange_GaussLobatto< GL_BASIS >::
 ...
 * Trilinear Cube finite element with a Gaussian quadrature rule. It is
 ...
 *
 */
using Q1_Cube_Lagrange_GaussLobatto = Qk_Cube_Lagrange_GaussLobatto< LagrangeBasis1 >;
/**
 * This class contains the kernel accessible functions specific to the standard
 * Trilinear Cube finite element with a Gaussian quadrature rule. It is
 * assumed that the indexing for the quadrature points mirrors that of the
 ...
 *
 */
using Q2_Cube_Lagrange_GaussLobatto = Qk_Cube_Lagrange_GaussLobatto< LagrangeBasis2 >;
/**
 * This class contains the kernel accessible functions specific to the standard
 * Trilinear Cube finite element with a Gaussian quadrature rule. It is
 * assumed that the indexing for the quadrature points mirrors that of the
 ...
 *
 */
using Q3_Cube_Lagrange_GaussLobatto = Qk_Cube_Lagrange_GaussLobatto< LagrangeBasis3GL >;
/**
 * This class contains the kernel accessible functions specific to the standard
 * Trilinear Cube finite element with a Gaussian quadrature rule. It is
 * assumed that the indexing for the quadrature points mirrors that of the
 ...
 *
 */
using Q4_Cube_Lagrange_GaussLobatto = Qk_Cube_Lagrange_GaussLobatto< LagrangeBasis4GL >;
/**
 * This class contains the kernel accessible functions specific to the standard
 * Trilinear Cube finite element with a Gauss Lobatto quadrature rule. It is
 * assumed that the indexing for the quadrature points mirrors that of the
 * nodes. Also note that the assumed node ordering is not the standard
 * right-hand-rule used in the literature. Here we use a Cartesian aligned
 * numbering in order to simplify the mapping to the parent coordinates and
 ...
 *    0        1        2        3        4        5                   o----- xi0
 */
using Q5_Cube_Lagrange_GaussLobatto = Qk_Cube_Lagrange_GaussLobatto< LagrangeBasis5GL >;
