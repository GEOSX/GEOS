                                                   ...
                                                   real64 ( & elasticStrainInc)[6] ) const
{
  ...
  elasticStrainInc[0] = ( (m_c22[k]*m_c33[k] - m_c23[k]*m_c23[k])*(m_newStress[k][q][0] - m_oldStress[k][q][0]) + (m_c13[k]*m_c23[k] - m_c12[k]*m_c33[k])*(m_newStress[k][q][1] - m_oldStress[k][q][1]) + (m_c12[k]*m_c23[k] - m_c13[k]*m_c22[k])*(m_newStress[k][q][2] - m_oldStress[k][q][2]) ) / detC;
  elasticStrainInc[1] = ( (m_c23[k]*m_c13[k] - m_c12[k]*m_c33[k])*(m_newStress[k][q][0] - m_oldStress[k][q][0]) + (m_c11[k]*m_c33[k] - m_c13[k]*m_c13[k])*(m_newStress[k][q][1] - m_oldStress[k][q][1]) + (m_c13[k]*m_c12[k] - m_c11[k]*m_c23[k])*(m_newStress[k][q][2] - m_oldStress[k][q][2]) ) / detC;
  elasticStrainInc[2] = ( (m_c12[k]*m_c23[k] - m_c22[k]*m_c13[k])*(m_newStress[k][q][0] - m_oldStress[k][q][0]) + (m_c12[k]*m_c13[k] - m_c11[k]*m_c23[k])*(m_newStress[k][q][1] - m_oldStress[k][q][1]) + (m_c11[k]*m_c22[k] - m_c12[k]*m_c12[k])*(m_newStress[k][q][2] - m_oldStress[k][q][2]) ) / detC;

  elasticStrainInc[3] = (m_newStress[k][q][3] - m_oldStress[k][q][3]) / m_c44[k];
  elasticStrainInc[4] = (m_newStress[k][q][4] - m_oldStress[k][q][4]) / m_c55[k];
