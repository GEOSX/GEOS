...
protected:
  ...
  arrayView4d< real64, relperm::USD_RELPERM > m_phaseTrappedVolFrac;
...
public:
  ...
  arrayView4d< real64 const, relperm::USD_RELPERM > phaseTrappedVolFraction() const { return m_phaseTrappedVolFrac; }
...
protected:
  ...
  array4d< real64, relperm::LAYOUT_RELPERM > m_phaseTrappedVolFrac;
